...
contract Vote {
    ...
    function voteForCandidate(string memory candidate) public {
        require(!hasVoted[msg.sender], "Vous avez deja vote."); // Vérifie que l'utilisateur n'a pas déjà voté
        ...
        emit Voted(msg.sender, candidate); // Événement pour indiquer qu'un vote a été enregistré
    }
